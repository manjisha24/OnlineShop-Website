...
import{ getFirestore, doc, collection, setDoc, getDoc, updateDoc, query, where, deleteDoc, getDocs, limit} from "firebase/firestore";
...
app.get('/success', async (req, res)=>{
    ...
    try{
        ...
        await setDoc(doc(orders_collection, docName), JSON.parse(order))
        .then(data=>{
